...
/* Minimum for 490 kiB + 1 user control page */
int sysctl_perf_event_mlock __read_mostly = 490 + (PAGE_SIZE / 1024); /* 'free' kiB per user */
...
#define DEFAULT_CPU_TIME_MAX_PERCENT	8	
